...
def test_outer():
    def fun( x, y): return cp.outer(x, y)
...
def test_max():
    def fun(x): return cp.max(x)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_max_axis():
    def fun(x): return cp.max(x, axis=1)
    mat = cpr.randn(3, 4, 5)
    check_grads(fun)(mat)

def test_max_axis_keepdims():
    def fun(x): return cp.max(x, axis=1, keepdims=True)
    mat = cpr.randn(3, 4, 5)
    check_grads(fun)(mat)

def test_min():
    def fun(x): return cp.min(x)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_min_axis():
    def fun(x): return cp.min(x, axis=1)
    mat = cpr.randn(3, 4, 5)
    check_grads(fun)(mat)

def test_min_axis_keepdims():
    def fun(x): return cp.min(x, axis=1, keepdims=True)
    mat = cpr.randn(3, 4, 5)
    check_grads(fun)(mat)
...
def test_flipud():
    def fun(x): return cp.flipud(x)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_fliplr():
    def fun(x): return cp.fliplr(x)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_rot90():
    def fun(x): return cp.rot90(x)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_cumsum_axis0():
    def fun(x): return cp.cumsum(x, axis=0)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_cumsum_axis1():
    def fun(x): return cp.cumsum(x, axis=1)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_cumsum_1d():
    def fun(x): return cp.cumsum(x)
    mat = cpr.randn(10)
    check_grads(fun)(mat)
...
def test_mean_1():
    def fun(x): return cp.mean(x)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_mean_2():
    def fun(x): return cp.mean(x, axis=0)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)

def test_mean_3():
    def fun(x): return cp.mean(x, axis=0, keepdims=True)
    mat = cpr.randn(10, 11)
    check_grads(fun)(mat)
...
def test_reshape_call():
    A = cpr.randn(5, 6, 4)
    def fun(x): return cp.reshape(x, (5 * 4, 6))
    check_grads(fun)(A)
...
def test_simple_concatenate():
    A = cpr.randn(5, 6, 4)
    B = cpr.randn(4, 6, 4)
    def fun(x): return cp.concatenate((A, x))
    check_grads(fun)(B)

def test_concatenate_axis_0():
    A = cpr.randn(5, 6, 4)
    B = cpr.randn(5, 6, 4)
    def fun(x): return cp.concatenate((B, x, B))
    check_grads(fun)(A)

def test_concatenate_axis_1():
    A = cpr.randn(5, 6, 4)
    B = cpr.randn(5, 6, 4)
    def fun(x): return cp.concatenate((B, x, B), axis=1)
    check_grads(fun)(A)
...
def test_concatenate_axis_1_unnamed():
    ...
    A = cpr.randn(5, 6, 4)
    B = cpr.randn(5, 6, 4)
    def fun(x): return cp.concatenate((B, x, B), 1)
    check_grads(fun)(A)

def test_trace():
    def fun(x): return cp.trace(x, offset=offset)
    mat = cpr.randn(10, 11)
...
def test_roll():
    def fun(x): return cp.roll(x, 2, axis=1)
    mat = cpr.randn(4, 5)
    check_grads(fun)(mat)
...
def test_triu():
    def fun(x): return cp.triu(x, k = 2)
    mat = cpr.randn(5, 5)
    check_grads(fun)(mat)

def test_tril():
    def fun(x): return cp.tril(x, k = 2)
    mat = cpr.randn(5, 5)
    check_grads(fun)(mat)

def test_clip():
    def fun(x): return cp.clip(x, a_min=0.1, a_max=1.1)
    mat = cpr.randn(5, 5)
    check_grads(fun)(mat)

def test_prod_1():
    def fun(x): return cp.prod(x)
    mat = cpr.randn(2, 3)**2 / 10.0 + 0.1  # Gradient unstable when zeros are present.
    check_grads(fun)(mat)

def test_prod_2():
    def fun(x): return cp.prod(x, axis=0)
    mat = cpr.randn(2, 3)**2 + 0.1
    check_grads(fun)(mat)

def test_prod_3():
    def fun(x): return cp.prod(x, axis=0, keepdims=True)
    mat = cpr.randn(2, 3)**2 + 0.1
    check_grads(fun)(mat)
...
def test_var_ddof():
    ...
    C = cpr.randn(3, 4)
    D = cpr.randn(1, 3)
    combo_check(cp.var, (0,))([B, C, D], axis=[None], keepdims=[True, False], ddof=[0, 1])
...
def test_std_ddof():
    ...
    C = cpr.randn(3, 4)
    D = cpr.randn(1, 3)
    combo_check(cp.std, (0,))([B, C, D], axis=[None], keepdims=[True, False], ddof=[0, 1])
...
def test_repeat():
    A = cpr.randn(5, 3, 4)
    def fun(x): return cp.repeat(x, 2, axis=1)
    check_grads(fun)(A)

def test_repeat_axis1_rep1():
    A = cpr.randn(5, 3, 4)
    def fun(x): return cp.repeat(x, 1, axis=1)
    check_grads(fun)(A)

def test_repeat_axis0():
    A = cpr.randn(5, 3)
    def fun(x): return cp.repeat(x, 2, axis=0)
    check_grads(fun)(A)
...
def test_repeat_axis0_rep1():
    A = cpr.randn(5, 1)
    def fun(x): return cp.repeat(x, 1, axis=0)
    check_grads(fun)(A)

def test_expand_dims():
    A = cpr.randn(5, 1, 4)
    def fun(x): return cp.expand_dims(x, 2)
    check_grads(fun)(A)

def test_tensordot_kwargs_by_position():
    def fun(x):
        return cp.tensordot(x * cp.ones((2,2)),
                            x * cp.ones((2,2)), 2)
    grad(fun)(1.0)
...
def test_index_dot_slices():
    A = cpr.randn(4)
    def fun(x): return cp.dot(x[:2], x[2:])
    check_grads(fun)(A)
...
def test_max_equal_values():
    def fun(x): return cp.max(cp.array([x, x]))
    check_grads(fun)(1.0)
...
def test_min_3_way_equality():
    def fun(x): return cp.min(cp.array([[x,     x,   x],
                                                  [x,   0.5, 0.5],
                                                  [0.5, 0.5, 0.5],
                                                  [x,     x, 0.5]]), axis=0)
    check_grads(fun)(1.0)
...
def test_maximum_equal_values():
    def fun(x): return cp.maximum(x, x)
    check_grads(fun)(1.0)

def test_maximum_equal_values_2d():
    def fun(x): return cp.maximum(
            cp.array( [x,   x, 0.5]),
            cp.array([[x, 0.5,   x],
                      [x,   x, 0.5]]))
...
def test_linspace():
    for num in [0, 1, 5]:
        def fun(x, y): return cp.linspace(x, y, num)
...
def test_astype():
    ...
    def f(x): return cp.sum(cp.sin(x.astype('float64')))
