...
anp.array_split.defgrad(lambda ans, x, idxs, axis=0  : lambda g : anp.concatenate(g, axis=axis))
anp.split.defgrad(      lambda ans, x, idxs, axis=0  : lambda g : anp.concatenate(g, axis=axis))
anp.vsplit.defgrad(     lambda ans, x, idxs,         : lambda g : anp.concatenate(g, axis=0))
anp.hsplit.defgrad(     lambda ans, x, idxs,         : lambda g : anp.concatenate(g, axis=1))
anp.dsplit.defgrad(     lambda ans, x, idxs,         : lambda g : anp.concatenate(g, axis=2))
