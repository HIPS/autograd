...
anp.floor_divide.defgrad_is_zero()
anp.floor_divide.defgrad_is_zero(argnum=1)
anp.nan_to_num.defgrad_is_zero()
anp.logical_and.defgrad_is_zero()
anp.logical_or.defgrad_is_zero()
anp.logical_not.defgrad_is_zero()
anp.logical_xor.defgrad_is_zero()
anp.logical_and.defgrad_is_zero(argnum=1)
anp.logical_or.defgrad_is_zero(argnum=1)
anp.logical_not.defgrad_is_zero(argnum=1)
anp.logical_xor.defgrad_is_zero(argnum=1)
...
anp.greater.defgrad_is_zero()
anp.greater_equal.defgrad_is_zero()
anp.less.defgrad_is_zero()
anp.less_equal.defgrad_is_zero()
anp.equal.defgrad_is_zero()
anp.not_equal.defgrad_is_zero()
anp.greater.defgrad_is_zero(argnum=1)
anp.greater_equal.defgrad_is_zero(argnum=1)
anp.less.defgrad_is_zero(argnum=1)
anp.less_equal.defgrad_is_zero(argnum=1)
