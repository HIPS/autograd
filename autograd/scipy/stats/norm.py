...
pdf.defvjp(lambda ans, vs, gvs, x, loc=0.0, scale=1.0: lambda g:
...
cdf.defvjp(lambda ans, vs, gvs, x, loc=0.0, scale=1.0: lambda g:
...
logpdf.defvjp(lambda ans, vs, gvs, x, loc=0.0, scale=1.0: lambda g:
...
logcdf.defvjp(lambda ans, vs, gvs, x, loc=0.0, scale=1.0: lambda g:
