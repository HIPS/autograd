...
C = np.random.randn(200, 200, 5, 4)
D = np.random.randn(1, 1, 5, 4)
add_0 = lambda C, D, G: make_vjp(np.add, argnum=0)(C, D)[0](G)
tanh_0 = lambda C, G: make_vjp(np.tanh, argnum=0)(C)[0](G)
